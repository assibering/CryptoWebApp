...
def create_user_repository(db_context: Optional[AsyncSession] = None) -> UserRepositoryInterface:
    """
    ...
    if settings.DATABASE_TYPE == DatabaseType.POSTGRES:
        if db_context is None:
            raise ValueError("Database session is required for PostgreSQL repository")
